...
if ( ! Detector.webgl ) Detector.addGetWebGLMessage();
    ...
    var api_base = '<?php echo URL::base(); ?>',
        background = '<?php echo URL::site('media/background.jpg', null, false); ?>';
        api_sound_url = '<?php echo URL::site('media/sound.ogg', null, false); ?>',
        api_font_url = '<?php echo URL::site('media/font.json', null, false); ?>',
        api_user_url = '<?php echo URL::site('api/user'); ?>';
  ...
  function process_keyup(e) {
    ...
    if (next) { 
      ...
      ajax_request('<?php echo URL::site('api/user/lottery?phone='); ?>'+obj_selected.user.phone+'&lottery='+lottery_code, function(ret){
        console.log(ret);
      });
    }
  }
